...
IPCnewgroup::Open2 - open a process for both reading and writing using open2()
...
See L<IPCnewgroup::Open3> for an alternative that handles STDERR as well.  This
...
require IPCnewgroup::Open3;

sub open2 {
    local $Carp::CarpLevel = $Carp::CarpLevel + 1;
    return IPCnewgroup::Open3::_open3('open2', $_[1], $_[0], '>&STDERR', @_[2 .. $#_]);
}
