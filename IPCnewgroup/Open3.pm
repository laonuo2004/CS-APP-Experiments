...
IPCnewgroup::Open3 - open a process for reading, writing, and error handling using open3()
...
=item L<IPCnewgroup::Open2>

Like Open3 but without STDERR capture.

=item L<IPCnewgroup::Run>
...
sub _open3 {
	...
	if ($kidpid == 0) {  # Kid
		...
		return 1 if ($_[0] eq '-');
		# Put the child into another process group 
		setpgrp(0, 0);
		exec @_ or do {
		    local($")=(" ");
